...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingResponseDTO createBooking(BookingRequest request) {
        ...
        notificationService.createNotification(
            ...
            String.format("Bạn đã đặt phòng tại %s thành công. Mã đặt phòng: #%d", hotelName, booking.getBookingId()),
            "BOOKING_SUCCESS",
    ...
    public BookingResponseDTO confirmBooking(Integer bookingId) {
        ...
        notificationService.createNotification(
            ...
            String.format("Đặt phòng tại %s (Mã: #%d) đã được xác nhận. Chúc bạn có chuyến đi vui vẻ!", hotelName, booking.getBookingId()),
            "BOOKING_CONFIRMED",
            booking.getBookingId()
        );
